...
class Array {
    Scanner sc = new Scanner(System.in); // Field
    private int data[];
...
class Arrayy {
    ...
    {
        System.out.println(" Name : Katariya Shyam V. ");
        System.out.println(" Er.no.: 12102080603010 "); // Scanner sc = new Scanner(System.in);

        Array arr = new Array(new int[] { 21, 33, 50, 68, 99 });
        arr.reverse_array();
